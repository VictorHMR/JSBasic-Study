    ...
    function keyPush(event){              //Função para detectar os cliques do usuario
      ...
      switch(event.keyCode){
        ...
        case 37:                                                               //Numero da seta left
          ...
          break;
        case 38:                                                               //Numero da seta up
          vx = 0;                                                              //Transformando a direção de X em 0
          vy = -vel;                                                           //Transformando a direção de Y em uma posição para cima
          document.getElementById('upS').style.color = "blueviolet";
          setTimeout(function(){
            document.getElementById('upS').style.color = "white"}, 300)
          break;
        case 39:                                                                //Numero da seta right  
          vx = vel;                                                             //Transformando a direção de X em uma posição a direita
          vy = 0;                                                               //Transformando a direção de Y em 0
          document.getElementById('rightS').style.color = "blueviolet";
          setTimeout(function(){
            document.getElementById('rightS').style.color = "white"}, 300)
          break;
        case 40:                                                                //Numero da seta down
          vx = 0;                                                               //Transformando a direção de X em 0
          vy = vel;                                                             //Transformando a direção de Y em uma posição a baixo
